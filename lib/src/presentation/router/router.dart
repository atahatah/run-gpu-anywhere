...
import 'package:run_gpu_anywhere/src/presentation/pages/command_template/add_command_template.dart';
...
GoRouter router(RouterRef ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: AddCommandTemplatePage.pagePath,
        name: AddCommandTemplatePage.pageName,
        pageBuilder: (_, state) {
          return NoTransitionPage<void>(
            key: state.pageKey,
            child: AddCommandTemplatePage(),
          );
        },
      ),
    ],
